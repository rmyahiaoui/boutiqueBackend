 ...
 */
final class Version20200729204449 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D6905E54F6BD1646 ON hash_site (site_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D6905E54F6BD1646 ON hash_site');
